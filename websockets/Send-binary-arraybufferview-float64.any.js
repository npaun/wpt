...
const test = async_test("Send binary data on a WebSocket - ArrayBufferView - Float64Array - Connection should be closed");
...
wsocket.addEventListener('message', test.step_func(function(evt) {
  ...
  let resultView = new Float64Array(evt.data);
