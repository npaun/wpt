...
const test = async_test("Send binary data on a WebSocket - ArrayBufferView - Int16Array with offset - Connection should be closed");
...
wsocket.addEventListener('message', test.step_func(function(evt) {
  ...
  let resultView = new Int16Array(evt.data);
