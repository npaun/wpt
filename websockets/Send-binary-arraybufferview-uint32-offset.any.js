...
const test = async_test("Send binary data on a WebSocket - ArrayBufferView - Uint32Array with offset - Connection should be closed");
...
wsocket.addEventListener('message', test.step_func(function(evt) {
  ...
  let resultView = new Uint32Array(evt.data);
