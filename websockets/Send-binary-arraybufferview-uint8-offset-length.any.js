...
const test = async_test("Send binary data on a WebSocket - ArrayBufferView - Uint8Array with offset and length - Connection should be closed");
...
wsocket.addEventListener('message', test.step_func(function(evt) {
  ...
  let resultView = new Uint8Array(evt.data);
